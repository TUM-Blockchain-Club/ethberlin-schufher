                ...
                <div v-if="step === 1">
                  <v-row>
                    <v-col cols="12" md="6">
                      ...
                      <v-select v-model="form.salutation" :items="['Male', 'Female', 'Unknown']" variant="solo"></v-select>
                    </v-col>
                    <v-col cols="12" md="6">
                    ...
                    <v-col cols="12" md="6">
                      ...
                      <v-text-field v-model="form.houseNumber" type="number" variant="solo"></v-text-field>
                    </v-col>
                    <v-col cols="12" md="6">
                      <div class="field-label">Postcode</div>
                      <v-text-field v-model="form.postcode" type="number" variant="solo"></v-text-field>
                    </v-col>
                    <v-col cols="12" md="6">
                  ...
                  <v-btn @click="nextStep" color="#76ABAE" block large class="rounded-btn white-text short-btn">Next</v-btn>
                </div>
                      ...
                      <div class="checkbox-item">
                        ...
                        <div class="checkbox-content">
                          ...
                          <div class="checkbox-description">
                            Privacy Policy outlines how we collect, use, and protect your personal information. By checking
                            the checkbox, you agree to these terms regarding the handling of your data. Click here to read it.
                          </div>
                        </div>
                      </div>
                    </v-col>
                    <v-col cols="12">
                      <div class="checkbox-item">
                        ...
                        <div class="checkbox-content">
                          ...
                          <div class="checkbox-description">
                            Service Agreement defines the terms and conditions under which our credit scoring services are
                            provided. It covers aspects such as the scope of our services, pricing, payment terms, and the
                            process of calculating and delivering credit scores to users. Users are required to agree to these
                    ...
                    <v-col cols="12">
                      <div class="checkbox-item">
                        ...
                        <div class="checkbox-content">
                          ...
                          <div class="checkbox-description">
                            User Agreement governs your use of our credit scoring platform. It specifies the rules and
                            guidelines for accessing and using the platform, including acceptable behavior, prohibited
                            activities, and account security measures. By accessing and using our products, users agree to
                            abide by the terms outlined in this agreement. Click here to read it.
                          </div>
                        </div>
                      </div>
                    </v-col>
                  </v-row>
                  <v-btn @click="prevStep" color="#76ABAE" block class="rounded-btn white-text short-btn">Back</v-btn>
    ...
    methods: {
      ...
      async submitForm() {
        try {
          ...
          this.banksData = data.score;
          this.$router.push({ name: 'Results', params: { form: this.form, banksData: this.banksData } });
        } catch (error) {
